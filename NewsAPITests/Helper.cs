...
public static class Helper
{
    ...
    public static readonly string DatabaseSchema = Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Development" 
        ?  "tests"
        :  "news";
...
create table if not exists {DatabaseSchema}.articles
(
